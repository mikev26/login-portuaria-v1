...
def index():
    ...
    f_desde = fecha_valida(request.form.get('f_desde'), '2024-01-01')
    ...
    if request.method == 'POST':
        ...
        try:
            with conectar_db() as conn:
                ...
                # Normalización inteligente para asegurar compatibilidad total con fechas
                for r in registros:
            ...
            mensaje_error = f'No se pudo cargar el reporte: {e}'
